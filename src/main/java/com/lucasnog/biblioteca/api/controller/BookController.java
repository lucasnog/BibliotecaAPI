package com.lucasnog.biblioteca.api.controller;

import com.lucasnog.biblioteca.api.model.Book;
import com.lucasnog.biblioteca.api.repository.BookRepository;
...
public class BookController {
    ...
    public ResponseEntity<List<Optional<Book>>> getBookByAuthor(@PathVariable String author) {
        List<Optional<Book>> bookData = bookRepository.findByAuthor(author);
